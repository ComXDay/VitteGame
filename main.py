...
def show_info():
    draw_text('Деньги: ' + str(castle.money), font, GREY, 10, 10)
    draw_text('Очки: ' + str(castle.score), font, GREY, 180, 10)
    draw_text('Рекорд: ' + str(high_score), font, GREY, 180, 30)
    draw_text('Уровень: ' + str(level), font, GREY, SCREEN_WIDTH // 2, 10)
    draw_text('Здоровье: ' + str(castle.health) + " / " + str(castle.max_health), font, GREY, SCREEN_WIDTH - 230,
              SCREEN_HEIGHT - 50)
...
while run:
    ...
    if game_over == False:
        ...
        draw_text('ИГРА ОКОНЧЕНА!', font, GREY, 300, 300)
